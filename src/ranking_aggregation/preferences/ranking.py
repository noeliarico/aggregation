...
def print_ints_as_rankings(numbers, nalternatives=None, alternatives=None):
    """Receives a list of numbers and prints the rankings associated with them.

    :param numbers: List of numbers
    :type numbers: list

    :param nalternatives: Number of alternatives (optional)
    :type nalternatives: int

    :param alternatives: Names of the alternatives (optional)
    :type alternatives: np.array
...
def from_int_to_factoradic(idx, n=None):
    ...
    The factorial representation of a number is a way to represent it as a
    weighted sum of factorials of smaller numbers. For example, the number 10
    can be represented as [1, 2, 0, 0] because 10 = 1*3! + 2*2! + 0*1! + 0*0!.
