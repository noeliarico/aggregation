...
dispersion1 = 0.4
dispersion2 = 0.4
path_folder = "/Users/noeliarico/Desktop/Toulouse/code/cultures/profiles/mallow2/"
        ...
        for d in distance_between_the_base_rankings:
            ...
            for i in range(reps):
                if d != 1:
                    ...
                    ranking1, ranking2, reald = generate_initialization(
                        num_alternatives, d)
                ...
                instance.populate_mallows(num_voters, num_alternatives,
                                        [p1, 1-p1], [dispersion1, dispersion2],
                                        [ranking1, ranking2])
